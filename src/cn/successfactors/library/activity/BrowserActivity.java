...
public class BrowserActivity extends Activity implements OnScrollListener {
    ...
    private TimerTask searchTimerTask = new TimerTask() {
        ...
        public void run() {
            ...
            if (keyPressInsant != -1 && System.currentTimeMillis() - keyPressInsant > 800) {
    ...
    private void doSearch() { 
        ...
        if(strSearch.equals("")) {
            ...
            performRequest(Constants.ROOT_PATH + SEARCH_PATH + "书名/" + strSearch + "/"+pageNum+"/" + page);
        }
    }
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        @Override
        public View getView(final int tmpPosition, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.browser_book_item, null);
                holder.nameA = (TextView)convertView.findViewById(R.id.browserBookNameA);
                holder.imageA = (ImageView)convertView.findViewById(R.id.browserBookImageA);
                holder.nameB = (TextView)convertView.findViewById(R.id.browserBookNameB);
                holder.imageB = (ImageView)convertView.findViewById(R.id.browserBookImageB);
                holder.nameC = (TextView)convertView.findViewById(R.id.browserBookNameC);
                holder.imageC = (ImageView)convertView.findViewById(R.id.browserBookImageC);
            ...
            if(data.size() <= (position)) {
                ...
                UrlImageViewHelper.setUrlDrawable(holder.imageA, book.getBookPicUrl());
                ...
                holder.imageA.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(BrowserActivity.this, BookDetailActivity.class);
            ...
            if(data.size() <= (position+1)) {
                ...
                UrlImageViewHelper.setUrlDrawable(holder.imageB, book.getBookPicUrl());
            ...
            if(data.size() <= (position+2)) {
                ...
                UrlImageViewHelper.setUrlDrawable(holder.imageC, book.getBookPicUrl());
