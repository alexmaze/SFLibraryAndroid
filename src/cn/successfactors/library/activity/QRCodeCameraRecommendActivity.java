...
public class QRCodeCameraRecommendActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null){
        	String myParam = Constants.ROOT_PATH + GET_RECOMMEND_FROM_DOUBAN_PATH + bookISBN; 
    ...
    Handler recommendHandler = new Handler() {
        ...
        public void handleMessage(Message msg){
            ...
            switch(result) {
            	...
            	case REC_FAILED:
            		Toast.makeText(getApplicationContext(), QRCodeCameraRecommendActivity.this.getResources().getString(R.string.recommend_already), Toast.LENGTH_SHORT).show();
                    break;
                case REC_SUCCESS:
                	Toast.makeText(getApplicationContext(), QRCodeCameraRecommendActivity.this.getResources().getString(R.string.recommend_success), Toast.LENGTH_SHORT).show();
                    break;    
            }
        }
    };
