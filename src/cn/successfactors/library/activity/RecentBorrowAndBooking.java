...
import cn.successfactors.library.R.layout;
import cn.successfactors.library.R.menu;
import cn.successfactors.library.activity.BrowserActivity.MyAdapter;
import cn.successfactors.library.activity.BrowserActivity.ViewHolder;
...
public class RecentBorrowAndBooking extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_recent_borrow_and_booking);
		 ...
		 Bundle extras = getIntent().getExtras(); 
	        if (extras != null){
	        	String myParam = Constants.ROOT_PATH + "book/getbookborroworderlistbyisbn/" + extras.getString("url"); 
	 ...
	 public class MyAdapter1 extends BaseAdapter {
	        ...
	        public View getView(final int tmpPosition, View convertView, ViewGroup parent) {
	            ...
	            if (convertView == null) {
	                ...
	                convertView = mInflater.inflate(R.layout.current_book_borrow, null);
	                holder.borrowPerson = (TextView)convertView.findViewById(R.id.borrow_person);
	                holder.borrowDate = (TextView)convertView.findViewById(R.id.borrow_date);
	                holder.returnDate = (TextView)convertView.findViewById(R.id.return_date);
	 ...
	 public class MyAdapter2 extends BaseAdapter {
	        ...
	        public View getView(final int tmpPosition, View convertView, ViewGroup parent) {
	            ...
	            if (convertView == null) {
	                ...
	                convertView = mInflater.inflate(R.layout.current_book_booking, null);
 ...
 Handler handler = new Handler() {
        ...
        public void handleMessage(final Message msg) {
            ...
            Gson gson = new Gson();
            BookBorrowOrderListInfo info = gson.fromJson(bundleResult, BookBorrowOrderListInfo.class);
