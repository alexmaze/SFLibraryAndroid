...
public class RecommendDetailActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			String myParam = Constants.ROOT_PATH + GET_RECOMMEND_SUB_PATH
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(final Message msg) {
			...
			detailRecUser.setText(getResources().getString(
					R.string.recommend_user)
					+ recBook.getRecUserName());
		...
		public void handleMessage(Message msg) {
			...
			case REC_FAILED:
				Toast.makeText(
						...
						RecommendDetailActivity.this.getResources().getString(
								R.string.recommend_already), Toast.LENGTH_SHORT)
						.show();
				break;
			case REC_SUCCESS:
				Toast.makeText(
						getApplicationContext(),
						RecommendDetailActivity.this.getResources().getString(
								R.string.recommend_success), Toast.LENGTH_SHORT)
						.show();
				break;
			}
		}
