    ...
    public class MyAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.reserve_book_item, null);
                holder.name = (TextView)convertView.findViewById(R.id.reserveBookName);
                holder.author = (TextView)convertView.findViewById(R.id.reserveBookAuthor);
                holder.image = (ImageView)convertView.findViewById(R.id.reserveBookImage);
                holder.orderDate = (TextView)convertView.findViewById(R.id.reserveDate);
                holder.orderUser = (TextView)convertView.findViewById(R.id.reserveRecUser);
    ...
    Handler cancelHandler = new Handler() {
        ...
        public void handleMessage(Message msg){
            ...
            switch(result) {
            	...
            	case CANCEL_FAILED:
            		Toast.makeText(getApplicationContext(), ReservationActivity.this.getResources().getString(R.string.order_cancel_fail), Toast.LENGTH_SHORT).show();
                    break;
                case CANCEL_SUCCESS:
                	loadData();
                	Toast.makeText(getApplicationContext(), ReservationActivity.this.getResources().getString(R.string.order_cancel_success), Toast.LENGTH_SHORT).show();
                    break;    
            }
        }
    };
